...
<nav class="w-[600px] position-absolute top-center ml-20 bg-slate-300 rounded-full border-gray-200  dark:bg-gray-900">
  <div className="max-w-screen-xl  flex flex-col justify-center  items-center  mx-auto  p-4"> 
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul className="flex flex-row gap-10  ">
        <li>
          <a href="#" className="text-2xl bg-transparent hover:text-blue-500" aria-current="page">Home</a>
        </li>
        <li>
